  ...
  return (
    <div className={`relative w-full ${className}`} ref={dropdownRef}>
      <div
        ...
        className={`flex h-11 w-full items-center justify-between rounded-lg border border-gray-300 bg-white px-4 transition-all focus-within:border-blue-500 dark:border-gray-700 dark:bg-gray-900 ${
          disabled ? "opacity-60 cursor-not-allowed bg-gray-50" : "cursor-pointer"
        }`}
      >
        <span className={`text-sm ${selectedOption ? "text-gray-900 dark:text-white" : "text-gray-400"}`}>
      ...
      {isOpen && (
        <div className="absolute left-0 right-0 z-50 mt-1 max-h-80 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-900 animate-in fade-in zoom-in duration-150">
