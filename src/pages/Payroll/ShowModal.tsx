                ...
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mt-1 flex items-center gap-2 flex-wrap">
                      ...
                      <Calendar size={16} className="md:ml-2" /> Period:{" "}
                      {formatDateID(payroll.period.start)} -{" "}
                      {formatDateID(payroll.period.end)}
                    </p>
                  </div>
                </div>
                ...
                <div className="lg:col-span-7 space-y-6">
                  <section className="bg-emerald-50/30 dark:bg-emerald-950/10 border border-emerald-100 dark:border-emerald-900/30 rounded-3xl p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      {payroll.earnings.assessment_bonus > 0 && (
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-gray-500">
                            Performance Bonus
                          </span>
                          <span className="font-semibold text-emerald-600">
                            +{formatRupiah(payroll.earnings.assessment_bonus)}
                          </span>
                        </div>
                      )}
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center text-sm">
                        <div className="flex flex-col gap-1">
                          ...
                          {payroll.deductions.late_deduction > 0 && (
                            <span className="text-[10px] text-gray-400 ml-6">
                              Late:{" "}
                              {formatRupiah(payroll.deductions.late_deduction)}
                            </span>
                          )}
                          {payroll.deductions.early_leave_deduction > 0 && (
                            <span className="text-[10px] text-gray-400 ml-6">
                              Early Leave:{" "}
                              {formatRupiah(
                                payroll.deductions.early_leave_deduction,
                              )}
                            </span>
                          )}
                        </div>
                        <span
                          className={`font-semibold ${
                            payroll.deductions.total_attendance_deduction > 0
                              ? "text-red-600"
                              : "text-gray-400"
                          }`}
                        >
